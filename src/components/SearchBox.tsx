...
interface SearchBoxProps {
    onSearch: (query: string, type: "mobile" | "email") => void;
    isLoading?: boolean;
}
        ...
        <>
            ...
            >
                ...
                <div className="text-center mb-6">
                    <h1 className="text-3xl font-bold tracking-widest text-[#0F172A] font-orbitron">
                        DRISHTI
                    </h1>
                </div>
