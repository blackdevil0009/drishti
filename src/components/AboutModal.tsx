        ...
        >
            ...
            >
                ...
                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-white sticky top-0 z-10">
                    <h2 className="text-xl font-bold text-gray-900">About Drishti</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 text-gray-700 leading-relaxed">
                    ...
                    <div className="w-full rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                        <img
                            src="/yt-size-img.jpg"
                            alt="Drishti Mobile Number Tracker and Breach Check"
                        ...
                        <div className="flex gap-4 items-start p-5 bg-blue-50 rounded-2xl border border-blue-100">
                            ...
                            <div>
                                ...
                                <p className="text-sm md:text-base">
                                    Drishti was created with a single, critical mission: to raise awareness about the very real threat of data breaches and promote cybersecurity vigilance among individuals and organizations.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
                            ...
                            <a href="mailto:contact@drishti.org" className="text-blue-600 font-semibold hover:underline block">
                                contact@drishti.org
                            </a>
                        </div>
                    </section>
                ...
                <div className="p-4 border-t border-gray-100 bg-gray-50 text-center">
                    <p className="text-xs text-gray-500">
                        &copy; {new Date().getFullYear()} Drishti. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
