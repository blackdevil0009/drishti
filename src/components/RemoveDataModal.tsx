                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6 text-gray-700 leading-relaxed no-scrollbar backdrop-neutral-50">
                    ...
                    <article className="prose prose-sm md:prose-base max-w-none">
                        <section className="mb-6">
                            ...
                            <p>
                                At Drishti, we believe in the fundamental right to privacy. Even though we only aggregate publicly available data from breaches to warn users, we understand that you may not want your information to be searchable on our platform.
                            </p>
                        </section>
